  ...
  <div class="home-layout min-vh-100 bg-concrete">
    ...
    <header class="hero-section py-5 mb-5 shadow-lg position-relative">
      ...
      <div class="container position-relative z-1 text-center">
        ...
        >
          ...
          >
            <span class="badge bg-danger rounded-0 text-uppercase"
              >Restrito</span
            >
            <span class="text-light-fossil font-monospace small text-uppercase"
              >Sistema Operacional v4.0</span
            >
          </div>
        </div>
      </div>
    ...
    <div class="container pb-5">
      <div class="row g-4">
        <div class="col-lg-8">
          <div
            class="d-flex align-items-center mb-4 pb-2 border-bottom border-dark-subtle"
          >
            <i class="bi bi-broadcast fs-3 text-danger me-3 animate-pulse"></i>
            <h4
              class="fw-black text-uppercase m-0 text-dark-jungle tracking-wide"
            >
              Relatórios de Campo
            </h4>
          </div>
          ...
          <div
            v-else
            class="card fossil-card mb-5 bg-secondary-subtle border-secondary border-2 shadow-sm"
          >
            <div class="card-body p-3 d-flex align-items-center gap-3">
              <i class="bi bi-eye-slash-fill fs-3 text-secondary"></i>
              <div>
                <h6 class="fw-bold text-dark text-uppercase m-0">
                  Modo Observador
                </h6>
                <small class="text-muted font-monospace"
                  >Você não possui credenciais de pesquisador para catalogar
                  novas descobertas.</small
                >
              </div>
            </div>
          </div>
            ...
            <div v-if="page < totalPages" class="text-center mt-4 mb-5">
              ...
              >
                ...
                {{
                  isLoading
                    ? "Processando..."
                    : "Carregar Arquivos Mais Antigos"
                }}
              </button>
            </div>
        ...
        <div class="col-lg-4">
          ...
          >
            ...
            >
              <ul class="list-unstyled m-0 text-dark-jungle">
                ...
                >
                  <span
                    ><i class="bi bi-lightning-charge me-1"></i>Rede
                    Elétrica</span
                  >
                ...
                <li class="d-flex justify-content-between">
                  <span
                    ><i class="bi bi-cone-striped me-1"></i>Paddock T-Rex</span
                  >
          ...
          <div class="text-center opacity-50 mt-4">
            ...
            <p class="x-small text-uppercase fw-bold text-secondary mt-1">
              InGen Technologies
            </p>
          </div>
        </div>
...
.hero-section {
  ...
  background-image:
    linear-gradient(rgba(26, 47, 43, 0.9), rgba(26, 47, 43, 0.8)),
