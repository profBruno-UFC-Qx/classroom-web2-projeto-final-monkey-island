      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          ...
          <div class="d-flex align-items-center mb-4">
            ...
            <h3 class="fw-black text-uppercase m-0 text-dark-jungle">Ficha do Pesquisador</h3>
          </div>

          <div v-if="loading" class="text-center py-5">
            <div class="spinner-border text-warning" role="status"></div>
            <p class="mt-3 text-muted fw-bold small">Acessando banco de dados...</p>
          </div>

          <div v-else-if="error" class="alert alert-danger border-0 shadow-sm fw-bold text-center">
            <i class="bi bi-exclamation-triangle-fill me-2"></i> {{ error }}
            <br>
            <button class="btn btn-outline-danger btn-sm mt-3" @click="fetchProfile">Tentar Novamente</button>
          </div>
